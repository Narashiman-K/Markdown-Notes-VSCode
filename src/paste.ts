...
function promoteHeaderRows(html: string): string {
  ...
  for (const table of Array.from(doc.querySelectorAll('table'))) {
    ...
    // cells becomes a row of empty pipes nobody gains anything from.
     ...
     * under it, each spanning every column; promoting the first row declares
     * the table one column wide and truncates every row below it.
     */
    ...
    // Titles and captions are lifted out above the table rather than lost.
